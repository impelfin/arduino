...
void loop() {
 ...
 if(!volume.init(&card)) {
  ...
  if(startupTrigger == HIGH) { // No button press
    ...
    b = map(100, 0, 1023, 1, minBrightness);
  ...
  for(;;) {      
    ...
    if(++block >= nBlocks  || digitalRead(TRIGGER) == LOW) {                   // Past last block?
      block = 0;
    }
  oldswval = swval;
  switch (x)
  {
    case 0 : if(spd>1 && spd<3){delaytime=6700;}
    case 1 : if(spd>2 && spd<4){delaytime=6400;}
    case 2 : if(spd>3 && spd<5){delaytime=6100;}
    case 3 : if(spd>4 && spd<6){delaytime=5800;}
    case 4 : if(spd>5 && spd<7){delaytime=5500;}
    case 5 : if(spd>6 && spd<8){delaytime=5200;}
    case 6 : if(spd>7 && spd<9){delaytime=4900;}
    case 7 : if(spd>8 && spd<10){delaytime=4600;}
    case 8 : if(spd>9 && spd<11){delaytime=4300;}
    case 9 : if(spd>10 && spd<12){delaytime=4100;}  
    case 10 : if(spd>11 && spd<13){delaytime=3800;}
    case 11 : if(spd>12 && spd<14){delaytime=3500;}
    case 12 : if(spd>13 && spd<15){delaytime=3200;}
    case 13 : if(spd>14 && spd<16){delaytime=2700;}
    case 14 : if(spd>15 && spd<17){delaytime=2500;}
    case 15 : if(spd>16 && spd<18){delaytime=2300;}
    case 16 : if(spd>17 && spd<19){delaytime=2000;}
    case 17 : if(spd>18 && spd<20){delaytime=1700;}
    case 18 : if(spd>19 && spd<21){delaytime=1450;}
    case 19 : if(spd>20 && spd<22){delaytime=1300;}
    case 20 : if(spd>21 && spd<23){delaytime=1150;}
    case 21 : if(spd>22 && spd<24){delaytime=1000;}
    case 22 : if(spd>23 && spd<25){delaytime=850;}
    case 23 : if(spd>24 && spd<26){delaytime=600;}
    case 24 : if(spd>25 && spd<27){delaytime=500;}
    case 25 : if(spd>26 && spd<28){delaytime=400;}
    case 26 : if(spd>27 && spd<29){delaytime=300;}
    case 27 : if(spd>28 && spd<30){delaytime=200;}
    case 28 : if(spd>29 && spd<31){delaytime=100;}
    case 29 : if(spd>30 && spd<32){delaytime=50;}
    case 30 : if(spd>31 && spd<33){delaytime=25;}
    case 31 : if(spd>32 && spd<34){delaytime=1;}
  }
